...
- General sources 
	- Books:
		...
		- Advanced Apple Debugging & Reverse Engineering.pdf
			- mach-o
	- For518 <-- missing 
		- [blog with a sample from that course](https://hackmd.io/@M4shl3/Deep-Dive-Into-APFS-Structure)
- APFS
	- Apple official resourcces : 
		...
		- [introducing Apple File system ](https://archive.org/details/wwdc2016videos/701_hd_introducing_apple_file_system.mp4)(this video was deleted form apple docs) <- useless
	...
	- Vulns !
		...
		- {add more here}
- Plist
	- **[Property List Programming Guide](https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/PropertyLists/Introduction/Introduction.html)** - Complete guide to plists
	- info.plist
		- **[Information Property List Key Reference](https://developer.apple.com/library/archive/documentation/General/Reference/InfoPlistKeyReference/Introduction/Introduction.html)** - All standard keys
	- **[Core Foundation Keys](https://developer.apple.com/documentation/bundleresources/information_property_list)** - Modern key reference
	- Advanced PLIST Topics
		- Code Signing & Entitlements
			- **[Entitlements Documentation](https://developer.apple.com/documentation/bundleresources/entitlements)** - Security entitlements in plists
			- **[Code Signing Guide](https://developer.apple.com/library/archive/documentation/Security/Conceptual/CodeSigningGuide/)** - Relationship with Info.plist
		- Managed Preferences (MDM)
			- **[Configuration Profile Reference](https://developer.apple.com/business/documentation/Configuration-Profile-Reference.pdf)** - Enterprise plist management
			- **[MDM Protocol Reference](https://developer.apple.com/documentation/devicemanagement)** - Device management plists
- Bundles 
	- Official Apple Documentation
		- **[Bundle Programming Guide](https://developer.apple.com/library/archive/documentation/CoreFoundation/Conceptual/CFBundles/Introduction/Introduction.html)** - Complete bundle architecture
		- **[Bundle Resources](https://developer.apple.com/documentation/bundleresources)** - Modern documentation
		- **[NSBundle Class Reference](https://developer.apple.com/documentation/foundation/nsbundle)** - Bundle APIs
		- **[App Bundle Structure](https://developer.apple.com/documentation/bundleresources/placing_content_in_a_bundle)** - Modern bundle layout
- dyld (Dynamic Linker)
	- Official Apple Documentation
		- **[dyld Source Code](https://opensource.apple.com/source/dyld/)** - The actual source (best documentation)
		- **[Dynamic Loader Release Notes](https://developer.apple.com/documentation/macos-release-notes/dynamic-loader-release-notes)** - Version changes
		- **[Dynamic Library Programming Topics](https://developer.apple.com/library/archive/documentation/DeveloperTools/Conceptual/DynamicLibraries/100-Articles/OverviewOfDynamicLibraries.html)** - Comprehensive guide
	-  Understanding the Cache
		- **[dyld Shared Cache Format](https://iphonedev.wiki/Dyld_shared_cache)** - Technical details
		- **[Extracting Libraries from dyld_shared_cache](https://github.com/keith/dyld-shared-cache-extractor)** - Extraction tool
		- **[The dyld Shared Cache](https://pewpewthespells.com/blog/dyld_shared_cache.html)** - Deep dive article
	- Blog Posts & Articles
		- **[Mike Ash: dyld Dynamic Linking](https://www.mikeash.com/pyblog/friday-qa-2012-11-09-dyld-dynamic-linking-on-os-x.html)** - Excellent walkthrough
		- **[Dynamic Linking](https://pewpewthespells.com/blog/dynamic_linking.html)** - Detailed mechanics
		- **[Understanding dyld](https://www.emergetools.com/blog/posts/iOS-dyld-deep-dive)** - Modern deep dive
- Mach-O File Format
	- Official Apple Documentation
		- **[Mach-O Programming Topics](https://developer.apple.com/library/archive/documentation/DeveloperTools/Conceptual/MachOTopics/0-Introduction/introduction.html)** - Official guide
		- **[OS X ABI Mach-O File Format](https://github.com/aidansteele/osx-abi-macho-file-format-reference)** - Complete specification
		- **[Mach-O Runtime Architecture](https://developer.apple.com/library/archive/documentation/DeveloperTools/Conceptual/MachORuntime/index.html)** - Runtime details
	-  Comprehensive Guides
		- **[Parsing Mach-O Files](https://lowlevelbits.org/parsing-mach-o-files/)** - Alex Denisov's tutorial
		- **[The Mach-O Executable Format](https://blog.timac.org/2016/1018-analysis-of-the-facebook-app-for-ios/)** - Detailed walkthrough
		- **[Let's Build a Mach-O Executable](https://x86matthew.com/view_post?id=11)** - From scratch tutorial
	- Security Research
		- **[iOS App Reverse Engineering](https://github.com/iosre/iOSAppReverseEngineering)** - Mach-O in iOS context
		- **[macOS Code Injection](https://knight.sc/reverse%20engineering/2019/04/15/macos-code-injection.html)** - Security implications
		- **[Mach-O Tricks](https://blog.xpnsec.com/macos-injection-via-third-party-frameworks/)** - Advanced techniques
	- Sample Projects
		- **[Write a Mach-O Loader](https://github.com/qyang-nj/llios/tree/main/macho_parser)** - Educational implementation
		- **[Minimal Mach-O Executables](https://github.com/flowerinthenight/single-macho)** - Smallest valid files
		- **[Mach-O Kit](https://github.com/DeVaukz/MachO-Kit)** - Objective-C framework
	- GitHub Projects
		- **[mach-o Parser in Go](https://github.com/blacktop/go-macho)** - Go implementation
		- **[LIEF Project](https://github.com/lief-project/LIEF)** - Multi-format binary parser
		- **[machomachomangler](https://github.com/Tyilo/machomachomangler)** - Mach-O manipulation
	- Code Signing
		- **[Code Signing Guide](https://developer.apple.com/library/archive/documentation/Security/Conceptual/CodeSigningGuide/)** - Integration with Mach-O
		- **[Code Signature Format](https://github.com/thefloweringash/sigtool)** - Signature structure 
- extra: 
	- cryptex https://eclecticlight.co/2022/11/16/cryptex-how-a-custom-iphone-is-changing-macos-updates/
## Topics
- Mac OS architecture
	- history
	- overall view
...
![Pasted image 20251004221008](/Pasted%20image%2020251004221008.png)
Understanding where macOS came from helps contextualize its current architecture:

The NeXT Connection (why literally every thing starts with NS )
When Steve Jobs left Apple , he founded NeXT Computer and developed NeXTSTEP, a Unix-based operating system built on the Mach microkernel and BSD. This OS was revolutionary, featuring an object-oriented API and advanced development tools.
...
![Pasted image 20251004224356](/Pasted%20image%2020251004224356.png)

Darwin is the Unix-based core of macOS, and it's actually open source! This might surprise many, but you can browse Darwin's source code at [opensource.apple.com](https://opensource.apple.com/releases/) (older versions contain much much more code/info that newer ones !)
...
![Pasted image 20251004224426](/Pasted%20image%2020251004224426.png)
...
![Pasted image 20251004221331](/Pasted%20image%2020251004221331.png)
img source: https://github.com/Brandon7CC/mac-monitor/wiki/3.-macOS-System-Architecture


## 3. APFS: Apple's Modern File System
![Pasted image 20251004224151](/Pasted%20image%2020251004224151.png)
img source : [**Apple File System Reference**](https://developer.apple.com/support/apple-file-system/Apple-File-System-Reference.pdf): Official, but incomplete APFS spec

**Why APFS Matters:**  
APFS was built for SSDs (though it works on HDDs), with optimization for random access patterns and reduced write amplification—crucial for flash storage longevity.
#### 3.1 Volumes 
...
-> Unlike traditional partitioning where you must pre-allocate fixed sizes, APFS volumes grow and shrink as needed within the container's total space.
Modern macOS uses a split-volume approach:
...
- /private/var → /System/Volumes/Data/private/var
- /tmp → /System/Volumes/Data/tmp
...
Bundles are one of macOS's most elegant concepts—they're directories that the system treats as single files.
...
![Pasted image 20251004231305](/Pasted%20image%2020251004231305.png)
![Pasted image 20251004231232](/Pasted%20image%2020251004231232.png)
...
![Pasted image 20251004232022](/Pasted%20image%2020251004232022.png)
...
![Pasted image 20251004233246](/Pasted%20image%2020251004233246.png)
## 4. Mach-O: The Executable Format
